...
public class MecanumDrive extends LinearOpMode {
    ...
    BNO055IMU imu;
    Orientation angles;
//ignore everything until we don't
//reeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            float rightPower = gamepad1.right_trigger;
            float leftPower = gamepad1.left_trigger;
...
//            to go back and forwards
            ...
            if (gamepad2.left_stick_y!= 0){
                ...
                telemetry.addData("Value", "armMotor, moving in various directions");
                telemetry.addData("VALUE",gamepad2.left_stick_x );
            }
            else {
                armMotor.setPower(0);
            }
