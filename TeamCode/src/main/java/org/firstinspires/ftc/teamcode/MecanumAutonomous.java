...
public class MecanumAutonomous {
    ...
    public MecanumAutonomous(LinearOpMode dp) {
    ...
    public void comeDown() {
        ...
        hangerMotor.setTargetPosition(13 * 1440+50);
    ...
    public void sensingStrafeLeft() {
        while (!mineralDetector.getAligned() && depotAutonomous.opModeIsActive()){
            strafeLeftUntimed();
        }
        stop();
    }
    public void sensingStrafeRight(){
        while(!mineralDetector.getAligned() && depotAutonomous.opModeIsActive()){
            strafeRightUntimed();
        }
        stop();
    ...
    private void strafeRightUntimed() {
        telemetry.addData("The robot ", "Moved to the Left");

        backLeft.setDirection(DcMotor.Direction.FORWARD);
        frontLeft.setDirection(DcMotor.Direction.REVERSE);
        backRight.setDirection(DcMotor.Direction.FORWARD);
        frontRight.setDirection(DcMotor.Direction.REVERSE); //this is rite
    ...
    private void strafeLeftUntimed() {
        telemetry.addData("The robot ", "Moved to the Left");
    ...
    public float turnRightOnCenterAxis(int turnAngle) {
        ...
        backLeft.setPower(0.2);
        backRight.setPower(0.2);
        frontLeft.setPower(0.2); // poggers my doggers/(-_-)\_ ;
        frontRight.setPower(0.2);
